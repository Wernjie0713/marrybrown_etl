-- Run this on the CLOUD SQL SERVER to verify/fix etl_user setup
-- Execute in SQL Server Management Studio (SSMS) on the cloud server
...
WITH PASSWORD = 'ETL@MarryBrown2025!',
...
PRINT '======================================';
PRINT '';
PRINT 'Test connection with these credentials:';
PRINT '  Server: 10.0.1.194,1433';
PRINT '  Database: MarryBrown_DW';
PRINT '  Username: etl_user';
PRINT '  Password: ETL@MarryBrown2025!';
PRINT '';
GO
