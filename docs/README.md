...
| `xilnex_full_schema.json` | **Actual schema used for replication** ? full INFORMATION_SCHEMA dump (598 tables). Streaming/Parquet scripts read actual columns from this file to ensure 1:1 replication. |
